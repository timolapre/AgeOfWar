    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (EnemyBaseScript.SpawnList.Count >= 1)
                Sprite1.GetComponent<SpriteRenderer>().sprite = Resources.Load(BaseScript.WhatFaction + "/Units/" + BaseScript.WhatTier.ToString() + "_" + EnemyBaseScript.SpawnList[0].ToString(), typeof(Sprite)) as Sprite;
            else
                Sprite1.GetComponent<SpriteRenderer>().sprite = null;

            if (EnemyBaseScript.SpawnList.Count >= 2)
                Sprite2.GetComponent<SpriteRenderer>().sprite = Resources.Load(BaseScript.WhatFaction + "/Units/" + BaseScript.WhatTier.ToString() + "_" + EnemyBaseScript.SpawnList[1].ToString(), typeof(Sprite)) as Sprite;
            else
                Sprite2.GetComponent<SpriteRenderer>().sprite = null;

            if (EnemyBaseScript.SpawnList.Count >= 3)
                Sprite3.GetComponent<SpriteRenderer>().sprite = Resources.Load(BaseScript.WhatFaction + "/Units/" + BaseScript.WhatTier.ToString() + "_" + EnemyBaseScript.SpawnList[2].ToString(), typeof(Sprite)) as Sprite;
            else
                Sprite3.GetComponent<SpriteRenderer>().sprite = null;

            if (EnemyBaseScript.SpawnList.Count >= 4)
                Sprite4.GetComponent<SpriteRenderer>().sprite = Resources.Load(BaseScript.WhatFaction + "/Units/" + BaseScript.WhatTier.ToString() + "_" + EnemyBaseScript.SpawnList[3].ToString(), typeof(Sprite)) as Sprite;
            else
                Sprite4.GetComponent<SpriteRenderer>().sprite = null;

            if (EnemyBaseScript.SpawnList.Count >= 5)
                Sprite5.GetComponent<SpriteRenderer>().sprite = Resources.Load(BaseScript.WhatFaction + "/Units/" + BaseScript.WhatTier.ToString() + "_" + EnemyBaseScript.SpawnList[4].ToString(), typeof(Sprite)) as Sprite;
            else
                Sprite5.GetComponent<SpriteRenderer>().sprite = null;
        }
    }
