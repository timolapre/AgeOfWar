...
public class InputHelper {
	...
	public static Vector2 GetStick(int PlayerID)
	{
        ...
        if(PlayerID == 0)
            ...
            return new Vector2((Input.GetKey(KeyCode.UpArrow) ? -1 : 0) + (Input.GetKey(KeyCode.DownArrow) ? 1 : 0), (Input.GetKey(KeyCode.LeftArrow) ? -1 : 0) + (Input.GetKey(KeyCode.RightArrow) ? 1 : 0));
    }
